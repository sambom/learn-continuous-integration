...
SVC_NAME="actions.runner.sambom-learn-continuous-integration.MacBookPro"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (sambom-learn-continuous-integration.MacBookPro)"
